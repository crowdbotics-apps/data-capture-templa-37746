...
## Project Structure
    ...
    ├── data_tracker_templa_37746  # Django project configurations
...
1. Clone this repo and `cd data_tracker_templa_37746`
...
2. Clone this repo and `cd data_tracker_templa_37746`
